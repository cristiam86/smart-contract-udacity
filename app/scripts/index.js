...
const contract_address = '0x325a23701F306eBa9573400A45dC1427842074D0';
const contract_abi = [
    {
      "constant": true,
      "inputs": [
...
const createStar = async () => {
  // const instance = await contract.at(contract_address);
